...
settings.configure(
    ...
    ROOT_URLCONF="writer_service.main",
    TEMPLATES=[
        {
    ...
    WSGI_APPLICATION="writer_service.main.application",
    DATABASES={},
    LANGUAGE_CODE="en-us",
    TIME_ZONE="UTC",
    STATIC_URL="/static/",
...
from writer_service.presentation.writer_views import ShortenView
...
urlpatterns = [
    path("api/shorten", ShortenView.as_view(service=service)),
